...
python3 evaluation/inference_speculative_ensemble.py -c configs/wmt_de_en/speculative_ensemble_gemma_270m_gamma5.yaml -d cuda
python3 evaluation/inference_speculative_ensemble.py -c configs/wmt_de_en/speculative_ensemble_qwen_0.6b_gamma5.yaml -d cuda